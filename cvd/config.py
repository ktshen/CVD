...
BINANCE_FUTURES_REST_URL = os.getenv("BINANCE_FUTURES_REST_URL", "https://fapi.binance.com")
BINANCE_DEPTH_WS_URL = os.getenv("BINANCE_DEPTH_WS_URL", "wss://data-stream.binance.vision/ws")
QUOTE_ASSETS = {
    asset.strip().upper()
...
OI_CHANGE_LENGTH = int(os.getenv("CVD_OI_CHANGE_LENGTH", "5"))